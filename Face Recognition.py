...
attend_csv_path = r"Attendance.txt"
# GUIIIII
...
def about():
    os.startfile(r"C:\Users\Shubhangi\auto pilot\Face_Recognition\other_files\ABOUT OURSELVES.png")
...
imag = tk.PhotoImage(file=r"C:\Users\Shubhangi\auto pilot\Face_Recognition\other_files\bg4.png")

frame = cstk.CTkFrame(master=root)
frame.pack(padx=60,pady=20,fill="both",expand=True)

label = cstk.CTkLabel(master=frame,text="Attendance System",font=("Roboto",32),compound="left")
...
button2.place(relx=0.75,rely=0.56,anchor="w")
